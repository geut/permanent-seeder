...
Fork the project [on GitHub](https://github.com/geut/services) and check out your copy locally.

```bash
$ git clone git@github.com:username/services.git
$ cd services
$ npm install
$ git remote add upstream git://github.com/geut/services.git
```
